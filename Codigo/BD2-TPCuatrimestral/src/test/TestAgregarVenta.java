...
public class TestAgregarVenta {
	...
	public static void main(String[] args) {
		...
		Venta venta1 = new Venta("2019-03-02", "0001-00001", 560.20, "Efectivo",detalle1,emp2, emp3, cliente1);
		...
		Venta venta2 = new Venta("2019-03-03", "0001-00002", 203.12, "Efectivo",detalle2,emp1, emp2, cliente2);
		listaVentas.add(venta1);
		listaVentas.add(venta2);
		
		List<Detalle> detalle3 = new ArrayList<Detalle>();
		detalle3.add(new Detalle(1,producto4,2,160.44));detalle3.add(new Detalle(2,producto11,2,44.45));detalle2.add(new Detalle(3,producto4,1,21.52));
		Venta venta3 = new Venta("2019-03-04", "0001-00003", 120.30, "Efectivo",detalle3,emp2, emp3, cliente6);
		listaVentas.add(venta3);
		
		List<Detalle> detalle4 = new ArrayList<Detalle>();
		detalle4.add(new Detalle(1,producto1,3,140.44));detalle4.add(new Detalle(2,producto4,2,41.45));detalle4.add(new Detalle(3,producto8,2,17.71));
		Venta venta4 = new Venta("2019-05-12", "0001-00004", 420.69, "Tarjeta",detalle4,emp1, emp2, cliente5);
		listaVentas.add(venta4);
		
		List<Detalle> detalle5 = new ArrayList<Detalle>();
		detalle5.add(new Detalle(1,producto4,3,120.44));detalle5.add(new Detalle(2,producto9,2,41.45));detalle5.add(new Detalle(3,producto2,3,12.21));
		Venta venta5 = new Venta("2019-05-13", "0001-00005", 110.69, "Tarjeta",detalle5,emp2, emp3, cliente1);
		listaVentas.add(venta5);
		
		
		///VENTAS SUCURSAL 2
		List<Detalle> detalle6 = new ArrayList<Detalle>();
		detalle6.add(new Detalle(1,producto4,2,31.44));detalle6.add(new Detalle(2,producto11,1,13.45));detalle6.add(new Detalle(3,producto9,1,40.88));
		Venta venta6 = new Venta("2019-02-04", "0002-00001", 160.20, "Tarjeta",detalle6,emp4, emp6, cliente3);
		...
		Venta venta7 = new Venta("2019-02-12", "0002-00002", 760.20, "Efectivo",detalle7,emp5, emp5, cliente7);
		...
		Venta venta8 = new Venta("2019-04-21", "0002-00003", 123.81, "Tarjeta",detalle8,emp6, emp4, cliente2);
		...
		Venta venta9 = new Venta("2019-05-01", "0002-00004", 203.61, "Tarjeta",detalle9,emp5, emp5, cliente5);
		...
		Venta venta10 = new Venta("2019-05-04", "0002-00005", 701.61, "Efectivo",detalle10,emp4, emp6, cliente1);
		...
		Venta venta11 = new Venta("2019-01-21", "0003-00001", 222.91, "Efectivo",detalle11,emp7, emp3, cliente4);
		...
		Venta venta12 = new Venta("2019-02-02", "0003-00002", 103.91, "Tarjeta",detalle12,emp8, emp7, cliente4);
		...
		Venta venta13 = new Venta("2019-02-05", "0003-00003", 401.91, "Tarjeta",detalle13,emp7, emp3, cliente7);
